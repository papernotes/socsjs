...
exports.findCourse = function(term, classname, timeout, byId) {
    ...
    return sendRequest(options).then(function(body) {
        ...
        if (pages) {
            return new Promise(function(fulfill, reject) {
                ...
                return Promise.reject(errorDesc(err));
            });
        }
...
/* 
    ...
    options is a JSON object that requires a 'timeout' field
 */
...
function createCourse(html, classNumber, byId, id) {
    ...
    $("table.tbrdr").find("tr").each(function(i, element) {
        ...
        returnCourse.department = processor.department;
        returnCourse.code = processor.code;
        returnCourse.name = processor.name;
        returnCourse.units = processor.units;
    });
...
function errorDesc(err) {
    err['socsjs'] = 'The timeout may be too short or there is no internet connection';
    return err;
}
