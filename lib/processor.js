...
Processor.prototype.parse = function($, element, classNumber) {
    ...
    if (this.oldCourse && this.oldCourse.toLowerCase() != classNumber.toLowerCase()) {
        return;
    }
