...
Processor.prototype.parse = function($, element, classNumber) {
    ...
    $(element).children("td").each(function(i, element) {
        ...
        //TODO add support for section types
            ...
            // cancelled values
                ...
                parseElement = new CourseElement(type, sectionID, arr[4], null, null, null, null, 0, 0);
    ...
    if (parseElement) {
        ...
        if (parseElement.sectionID && !parseElement.isEnrollable && !parseElement.isCancelled) {
