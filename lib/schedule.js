...
exports.findCourse = function(term, classname, timeout) {
    ...
    return sendRequest(options, timeout).then(function(body) {
        ...
        var pages = isMultiPage(cheerio.load(body));
        ...
        if (pages) {
            ...
            return Promise.resolve(createCourse(cheerio.load(body), classNumber));
        }
    }).catch(function(err) {
        return Promise.reject(null);
    });
...
exports.findCourses = function(term, classnames, timeout) {
    var actions = classnames.map(function(x) {
...
exports.searchDepartment = function(term, departmentName, timeout, undergrad) {
    ...
    return sendRequest(options, timeout).then(function(body) {
        ...
        if (pages) {
            ...
            return Promise.resolve(findTitles(cheerio.load(body)));
        }
    })
...
function createCourse($, classNumber) {
    var returnCourse = new Course();
    var processor = new Processor();
